...
# SECURITY WARNING: keep the sample key used in production sample!
SECRET_KEY = sample.samplekey

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [sample.domain, sample.ip]
